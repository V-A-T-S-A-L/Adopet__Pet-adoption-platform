...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $query = "INSERT INTO shelterrequests (name, password, address, contact_info) VALUES('$user_name', '$password', '$add', '$email')";
...
<body>
  <div class="wrapper">
    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method = "post">
      ...
      <div class="input-box">
        <input type="text" name="user_id" placeholder="Shelter Name" required>
      ...
      <button type="submit" class="btn">Request</button><br><br>
    </form>
  </div>
</body>
</html> 
